...
apt-get update && apt-get -y -q install postgresql-client-9.3
...
ln -s /apache/aws-sdk/aws-java-sdk-1.7.4.jar hive/lib
ln -s /apache/aws-sdk/aws-java-sdk-1.7.4.jar spark/jars

wget https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-aws/2.7.3/hadoop-aws-2.7.3.jar
mv hadoop-aws-*.jar aws-sdk
ln -s /apache/aws-sdk/hadoop-aws-2.7.3.jar hive/lib
...
rm jdk8-linux-x64.tar.gz hadoop-2.7.3.tar.gz scala-2.11.8.tgz spark-2.4.4-bin-hadoop2.7.tgz apache-hive-2.3.4-bin.tar.gz livy-server-0.3.0.zip
